...
def init_app_config(app):
    ...
    app.config["RQ_QUEUE"] = os.environ.get("RQ_QUEUE", "documents")
    app.config["WORKER_CONCURRENCY"] = int(os.environ.get("WORKER_CONCURRENCY", "2"))
    app.config["JOB_TIMEOUT_SECONDS"] = int(os.environ.get("JOB_TIMEOUT_SECONDS", "900"))
    app.config["JOB_HEARTBEAT_SECONDS"] = int(os.environ.get("JOB_HEARTBEAT_SECONDS", "15"))
    app.config["JOB_LEASE_SECONDS"] = int(os.environ.get("JOB_LEASE_SECONDS", "90"))
    app.config["JOB_MAINTENANCE_SECONDS"] = int(os.environ.get("JOB_MAINTENANCE_SECONDS", "30"))
    app.config["WORKER_HEARTBEAT_TTL_SECONDS"] = int(os.environ.get("WORKER_HEARTBEAT_TTL_SECONDS", "75"))
